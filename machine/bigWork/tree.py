...
def run_decision_tree():
    ...
    # dataset.attribute_types = ['true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true',
    #                            'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true',
    #                            'true', 'true','true', 'true', 'true', 'true', 'true', 'true', 'true', 'true','false']
    dataset.attribute_types = ['true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'true',
                               'true', 'false']
    # dataset.attribute_types = ['true', 'true', 'true', 'true', 'true', 'true', 'true', 'true', 'false']
    ...
    for k in range(K):
        ...
        for instance in test_set.rows:
            ...
            results.append(str(result) == str(instance[-1][0]))
